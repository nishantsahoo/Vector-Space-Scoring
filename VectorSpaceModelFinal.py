...
import math
import os
import tkinter.filedialog as fileget
...
def browse_file():
    fname = fileget.askopenfilename(filetypes=(("Text Files", "*.txt"), ("All files", "*")))
    f = open(str(fname), "r")
    doc_text = f.read()
    print(doc_text)
    ...
    global doc_1, doc_2, doc_3, doc_4, doc_5

        # print("This is doc_1[0] "+doc_1)
...
def fetch():
    ...
    print(doc_3_tf)
    print()
    print('Term frequency of Document 4 -')
    print(doc_4_tf)
    print()
    print('Term frequency of Document 5 -')
    print(doc_5_tf)
    print()
    ...
    print(doc_3_tf_idf)
    print()
    print('tf-idf value of Document 4 -')
    print(doc_4_tf_idf)
    print()
    print('tf-idf value of Document 5 -')
    print(doc_5_tf_idf)
    print()
...
broButton = Button(root, text = 'Browse', command=browse_file,height = 1, width = 5)
